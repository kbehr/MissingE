...
ZH = cfg.Component(
    ...
    files = [
        'ee_ZH.root',
	#'/afs/cern.ch/user/j/jvonahne/work/public/newSamples/BESVBF100k/ee_ZH_Zmumu_Hbb_2.root',
	#'ee_VBF.root',
    ]
)
...
def is_bquark(ptc):
    ...
    '''
    return (abs(ptc.pdgid()) in [1,2,3,4,5,21]) and ptc.status() == 23
...
#selfmade btagging test
from heppy.analyzers.examples.missE.improvedroc import BTagger
selfbtag = cfg.Analyzer(
    BTagger,
    input_jets='rescaled_bjets',
)
